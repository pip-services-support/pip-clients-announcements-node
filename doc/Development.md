# Development and Testing Guide <br/> Announcements Microservice Client SDK for Node.js
...
```bash
git clone git@github.com:pip-services-support/pip-clients-announcements-node.git
```
